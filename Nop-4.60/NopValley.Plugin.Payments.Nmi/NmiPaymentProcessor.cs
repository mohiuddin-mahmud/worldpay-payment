...
using NopValley.Plugin.Payments.Nmi.Validators;
using Microsoft.AspNetCore.WebUtilities;
using NopValley.Plugin.Payments.Nmi.Components;

namespace NopValley.Plugin.Payments.Nmi
{
    /// <summary>
    ...
    {
        private const string NMI_DIRECT_POST_URL = "https://secure.networkmerchants.com/api/transact.php";// "https://msgpay.transactiongateway.com/api/transact.php";
        ...
        public async Task PostProcessPaymentAsync(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            var baseUrl = $"{_webHelper.GetStoreLocation()}Plugins/PaymentNmiPublic/PaymentResult";
