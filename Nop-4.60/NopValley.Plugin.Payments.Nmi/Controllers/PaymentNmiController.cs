    ...
    public class PaymentNmiController : BasePaymentController
    {
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var model = new ConfigurationModel
            {
                ...
                CheckoutKey = nmiPaymentSettings.CheckoutKey,
            ...
            if (storeScope > 0)
            {
                ...
                model.CheckoutKey_OverrideForStore = await _settingService.SettingExistsAsync(nmiPaymentSettings, x => x.CheckoutKey, storeScope);
        ...
        public async Task<IActionResult> Configure(ConfigurationModel model)
        {
            ...
            nmiPaymentSettings.CheckoutKey = model.CheckoutKey;
            ...
            await _settingService.SaveSettingOverridablePerStoreAsync(nmiPaymentSettings, x => x.CheckoutKey, model.CheckoutKey_OverrideForStore, storeScope, false);
